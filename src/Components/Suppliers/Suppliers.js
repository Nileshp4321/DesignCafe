    ...
    return (
        <>
            <div className='container mx-auto mt-32'>
                <div className='flex flex-wrap grid grid-flow-row-dense grid-cols-3 grid-rows-1'>
                    ...
                    <div className='flex justify-around items-center grid grid-cols-3 flex-wrap gap-4 container mx-auto justify-content-center col-span-2'>
                        <div className='mr-11'>
